...
class GraphTraversal:
    ...
    def query(
        ...
        if max_tokens > 0:
            ...
            # Returns RecallResults, whose .truncation names the budget when
            # results were cut — surfaced verbatim by the recall tool.
            return apply_token_budget(nodes, max_tokens)
